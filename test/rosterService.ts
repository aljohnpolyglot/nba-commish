import { ROSTER_URL, EXTRA_RETIRED_PLAYERS_URL } from '../src/constants';
import type { NBAGMRosterData, NBAPlayer as Player, NBATeam as Team, DraftPick, NBAGMPlayer, GamePhase } from '../src/types';
import JSONParserText from '../test/JSONParserText';
import { calculatePlayerOverallForYear, calculateTeamStrength } from '../src/utils/playerRatings';
