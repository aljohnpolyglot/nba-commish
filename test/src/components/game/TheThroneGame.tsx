    ...
    >
      ...
      <div className="flex-1 bg-[#0a0a0a] flex flex-col p-4 md:p-6 overflow-hidden">
        ...
        <div className="hidden md:block text-center mb-4">
          <div className="text-zinc-600 font-mono text-[10px] mb-2 tracking-[0.5em] uppercase">Tournament Regulation</div>
          <div className="flex items-center justify-center gap-6">
            <div>
              <div className="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-1">Target</div>
              <div className="text-2xl font-black font-mono text-yellow-500">11</div>
            </div>
          </div>
        </div>
