...
- Free Agents View → user correction after MVP text: in Euro GM mode this is **unattached players only**. Club-attached players belong to Transfer Market / Expiring own-player extension flows, not the FA board.
