...
import { TRAINING_WEIGHTS, type TrainingFocusWeights } from './trainingFocusWeights';
...
export { TRAINING_WEIGHTS, type TrainingFocusWeights } from './trainingFocusWeights';
