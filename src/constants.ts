...
export const INITIAL_LEAGUE_STATS: LeagueStats = {
 ...
 [
  ...
  allStarShootingStarsTeams: 4,
  allStarShootingStarsPlayersPerTeam: 3,
  allStarShootingStarsTotalPlayers: 12,
  allStarSkillsChallenge: false,
  allStarSkillsChallengeMode: 'individual',
  allStarSkillsChallengeTeams: 4,
  allStarSkillsChallengePlayersPerTeam: 1,
  allStarSkillsChallengeTotalPlayers: 4,
  allStarHorse: false,
  allStarHorseParticipants: 3,
  allStarHorseNoPlayerRepeat: false,
  allStarHorseNoGlobalRepeat: false,
