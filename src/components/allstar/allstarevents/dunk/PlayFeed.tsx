...
import { Play, NBAPlayer } from '../../../../services/allStar/AllStarDunkContestSim';
...
export const DunkContestPlayFeed: React.FC<PlayFeedProps> = ({ plays, currentIndex, contestants }) => {
