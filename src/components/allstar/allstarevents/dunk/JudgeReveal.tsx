...
import { Play } from '../../../../services/allStar/AllStarDunkContestSim';
import { Judge } from '../../../../services/allStar/judges';
import { Star } from 'lucide-react';

interface JudgeRevealProps {
  data: NonNullable<Play['triggerJudgeModal']>;
  judges: Judge[];
  onClose: () => void;
}

export function DunkContestJudgeReveal({ data, judges, onClose }: JudgeRevealProps) {
