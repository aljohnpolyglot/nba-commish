...
interface ScoreboardProps {
  ...
  winnerId?: string;
  simResult: any; // or DunkContestResult
}

/**
 * Live Scoreboard for the Dunk Contest.
 * Shows player status, scores, and progress.
 */
export const Scoreboard: React.FC<ScoreboardProps> = ({ contestants, liveScores, currentPlay, winnerId, simResult }) => {
