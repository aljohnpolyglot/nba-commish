...
export const BudgetReviewModal: React.FC<BudgetReviewModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[130] flex items-center justify-center p-4">
      ...
      <div className="relative flex w-full max-w-xl max-h-[92vh] flex-col overflow-hidden rounded-2xl border border-amber-500/30 bg-slate-950 text-white shadow-2xl">
        <div className="flex items-start justify-between gap-4 border-b border-slate-800 bg-amber-500/[0.06] px-6 py-5">
          <div className="min-w-0">
            ...
            <h2 className="mt-2 text-3xl font-black uppercase tracking-tight">Budget Review</h2>
