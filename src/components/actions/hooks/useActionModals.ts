...
export const useActionModals = () => {
  ...
  const [modalType, setModalType] = useState<'suspension' | 'drug_test' | 'dinner' | 'general' | 'fine' | 'bribe' | 'movie' | 'leak_scandal' | 'give_money' | 'contact' | 'hypnotize' | 'sabotage' | 'club'>('general');
  ...
  const openPersonSelector = (type: 'suspension' | 'drug_test' | 'dinner' | 'fine' | 'bribe' | 'movie' | 'leak_scandal' | 'give_money' | 'contact' | 'hypnotize' | 'sabotage' | 'club') => {
