...
interface GameStructureSectionProps {
    ...
    setGameFormat: (val: 'timed' | 'target_score' | 'elam_ending') => void;
            ...
            <div className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-2">
                        ...
                        <select 
                            value={gameFormat} 
                            onChange={(e) => setGameFormat(e.target.value as 'timed' | 'target_score' | 'elam_ending')} 
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    {gameFormat === 'timed' ? (
                        ...
                        <div className="col-span-2 space-y-4">
                            ...
                            <div className="p-4 bg-indigo-500/5 border border-indigo-500/10 rounded-2xl">
                                <p className="text-[10px] text-indigo-300 font-medium leading-relaxed">
                                    ELAM ENDING: Play standard timed regulation, then remove the clock and set the final target to the leading score plus the target points above.
                                </p>
                            </div>
                        </div>
                    )}
