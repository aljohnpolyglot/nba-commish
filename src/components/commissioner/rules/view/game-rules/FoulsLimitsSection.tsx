...
export const FoulsLimitsSection: React.FC<FoulsLimitsSectionProps> = ({
    ...
    return (
        <div className="bg-slate-800/40 p-6 rounded-3xl border border-slate-800/50 space-y-4">
            ...
            {/* Foul limits and common foul toggles feed simulator FT, foul, turnover, and rim-rate knobs. */}
            {/* Ejection/card limits are stored only until event-level ejection handling exists. */}
