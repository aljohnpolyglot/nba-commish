...
export const SponsorshipSection: React.FC<{
  ...
  const placeholderCount = Math.max(0, PORTFOLIO_MAX - ALL_SLOTS.length);
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-5">
            ...
            <div className="grid md:grid-cols-2 2xl:grid-cols-4 gap-4">
              ...
              {Array.from({ length: placeholderCount }).map((_, i) => (
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="text-xs font-black uppercase tracking-widest text-slate-500">Available Slot</div>
                  ...
                  <div className="mt-4 flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-xs text-slate-500 mt-0.5">New opportunity</div>
                    </div>
                  </div>
                  <div className="mt-4 grid grid-cols-2 gap-3 text-xs">
                    <div>
                    ...
                    <div>
                      ...
                      <div className="text-sm font-black text-slate-300">Market</div>
                    </div>
                  </div>
