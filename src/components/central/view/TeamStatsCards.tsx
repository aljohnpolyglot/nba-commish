...
export const TeamStatsCards: React.FC<TeamStatsCardsProps> = ({ conferenceRank, rosterSize, marketTier, rankLabel = 'Conference Rank' }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
      {[
        { label: rankLabel, value: conferenceRank ? `#${conferenceRank}` : '-', icon: Trophy, color: 'text-amber-400' },
