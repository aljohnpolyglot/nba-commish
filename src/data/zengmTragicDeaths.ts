// Source copied from ZenGM:

// https://github.com/zengm-games/zengm/blob/master/src/worker/util/defaultTragicDeaths.ts
export const zengmDefaultTragicDeathReasons = [
  'SPECIAL_CLUE',
  'SPECIAL_GIFTS',
  ...
  'PLAYER_NAME was pursued by a bear, and mauled.',
  ...
  "PLAYER_NAME was intensely focused on playing Basketball GM on PRONOUN_his cell phone. As PRONOUN_he walked across the street, PRONOUN_he was so distracted by PRONOUN_his ultimately fatal obsession that PRONOUN_he didn't notice the bus barreling towards PRONOUN_him.",
...
export const zengmUsableTragicDeathReasons = zengmDefaultTragicDeathReasons.filter(
  reason => !reason.startsWith('SPECIAL_'),
);
